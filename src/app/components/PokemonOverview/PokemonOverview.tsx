...
const PokemonOverview = ({ pokemon }: { pokemon: any }) => {
  return (
    <Container>
      <div className="flex flex-col items-center justify-center">
        <div className="relative w-fit mx-auto">
          <div className="text-[10rem] text-gray-200 font-bold absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-0">
            #{pokemon.id}
          </div>
